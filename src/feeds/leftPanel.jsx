...
export default function LeftPanel() {
    ...
    return (
        <div className='flex flex-col bg-black w-[60%] h-full justify-start content-start mx-auto'>
        <div className='h-[30px] w-[30px] my-2 ml-6  '>
        ...
        <div className='flex flex-col justify-between  h-[60%] bg-black p-2 gap-y-3.5'>
        <div className='flex gap-4 hover:bg-zinc-900 px-4 py-2  rounded-3xl cursor-pointer w-fit'>
        <div className='h-[30px] w-[30px]'>
        <svg  viewBox="0 0 24 24"  aria-hidden="true" className="fill-gray-200 r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M22.58 7.35L12.475 1.897c-.297-.16-.654-.16-.95 0L1.425 7.35c-.486.264-.667.87-.405 1.356.18.335.525.525.88.525.16 0 .324-.038.475-.12l.734-.396 1.59 11.25c.216 1.214 1.31 2.062 2.66 2.062h9.282c1.35 0 2.444-.848 2.662-2.088l1.588-11.225.737.398c.485.263 1.092.082 1.354-.404.263-.486.08-1.093-.404-1.355zM12 15.435c-1.795 0-3.25-1.455-3.25-3.25s1.455-3.25 3.25-3.25 3.25 1.455 3.25 3.25-1.455 3.25-3.25 3.25z"></path></g></svg></div>
        <h3 className='text-lg font-bold text-gray-200 align-bottom  pt-[2px]'>Home</h3></div>
        <div className='flex gap-4 hover:bg-zinc-900 px-4 py-2  rounded-3xl cursor-pointer w-fit'>
        <div className='h-[30px] w-[30px]'>
        <svg 
 viewBox="0 0 24 24" aria-hidden="true" className="fill-gray-200 r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M21 7.337h-3.93l.372-4.272c.036-.412-.27-.775-.682-.812-.417-.03-.776.27-.812.683l-.383 4.4h-6.32l.37-4.27c.037-.413-.27-.776-.68-.813-.42-.03-.777.27-.813.683l-.382 4.4H3.782c-.414 0-.75.337-.75.75s.336.75.75.75H7.61l-.55 6.327H3c-.414 0-.75.336-.75.75s.336.75.75.75h3.93l-.372 4.272c-.036.412.27.775.682.812l.066.003c.385 0 .712-.295.746-.686l.383-4.4h6.32l-.37 4.27c-.036.413.27.776.682.813l.066.003c.385 0 .712-.295.746-.686l.382-4.4h3.957c.413 0 .75-.337.75-.75s-.337-.75-.75-.75H16.39l.55-6.327H21c.414 0 .75-.336.75-.75s-.336-.75-.75-.75zm-6.115 7.826h-6.32l.55-6.326h6.32l-.55 6.326z"></path></g></svg></div>
        <h3 className='text-lg font-semibold text-gray-200 align-bottom  pt-[2px]'>Explore</h3></div>
        <div className='flex gap-4 hover:bg-zinc-900 px-4 py-2  rounded-3xl cursor-pointer w-fit'>
        <div className='h-[30px] w-[30px]'>
        ...
        <h3 className='text-lg font-semibold text-gray-200 align-bottom  pt-[2px] '>Notifications</h3></div>
        <div className='flex gap-4 hover:bg-zinc-900 px-4 py-2  rounded-3xl cursor-pointer w-fit' >
        <div className='h-[30px] w-[30px]'>
        <svg 
 viewBox="0 0 24 24" aria-hidden="true" className="fill-gray-200 r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M19.25 3.018H4.75C3.233 3.018 2 4.252 2 5.77v12.495c0 1.518 1.233 2.753 2.75 2.753h14.5c1.517 0 2.75-1.235 2.75-2.753V5.77c0-1.518-1.233-2.752-2.75-2.752zm-14.5 1.5h14.5c.69 0 1.25.56 1.25 1.25v.714l-8.05 5.367c-.273.18-.626.182-.9-.002L3.5 6.482v-.714c0-.69.56-1.25 1.25-1.25zm14.5 14.998H4.75c-.69 0-1.25-.56-1.25-1.25V8.24l7.24 4.83c.383.256.822.384 1.26.384.44 0 .877-.128 1.26-.383l7.24-4.83v10.022c0 .69-.56 1.25-1.25 1.25z"></path></g></svg></div>
        <h3 className='text-lg font-semibold text-gray-200 align-bottom  pt-[2px]'>Messages</h3></div>
        <div className='flex gap-4 hover:bg-zinc-900 px-4 py-2  rounded-3xl cursor-pointer w-fit'>
        <div className='h-[30px] w-[30px]'>
        <svg 
 viewBox="0 0 24 24" aria-hidden="true" className="fill-gray-200 r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M12 11.816c1.355 0 2.872-.15 3.84-1.256.814-.93 1.078-2.368.806-4.392-.38-2.825-2.117-4.512-4.646-4.512S7.734 3.343 7.354 6.17c-.272 2.022-.008 3.46.806 4.39.968 1.107 2.485 1.256 3.84 1.256zM8.84 6.368c.162-1.2.787-3.212 3.16-3.212s2.998 2.013 3.16 3.212c.207 1.55.057 2.627-.45 3.205-.455.52-1.266.743-2.71.743s-2.255-.223-2.71-.743c-.507-.578-.657-1.656-.45-3.205zm11.44 12.868c-.877-3.526-4.282-5.99-8.28-5.99s-7.403 2.464-8.28 5.99c-.172.692-.028 1.4.395 1.94.408.52 1.04.82 1.733.82h12.304c.693 0 1.325-.3 1.733-.82.424-.54.567-1.247.394-1.94zm-1.576 1.016c-.126.16-.316.246-.552.246H5.848c-.235 0-.426-.085-.552-.246-.137-.174-.18-.412-.12-.654.71-2.855 3.517-4.85 6.824-4.85s6.114 1.994 6.824 4.85c.06.242.017.48-.12.654z"></path></g></svg></div>
        <h3 className='text-lg font-semibold text-gray-200 align-bottom  pt-[2px]'>Profile</h3></div>
 ...
 viewBox="0 0 24 24" aria-hidden="true" className="fill-gray-200 r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><circle cx="17" cy="12" r="1.5"></circle><circle cx="12" cy="12" r="1.5"></circle><circle cx="7" cy="12" r="1.5"></circle><path d="M12 22.75C6.072 22.75 1.25 17.928 1.25 12S6.072 1.25 12 1.25 22.75 6.072 22.75 12 17.928 22.75 12 22.75zm0-20C6.9 2.75 2.75 6.9 2.75 12S6.9 21.25 12 21.25s9.25-4.15 9.25-9.25S17.1 2.75 12 2.75z"></path></g></svg></div>
        <h3 className='text-lg font-semibold text-gray-200 align-bottom  pt-[2px]'>More</h3></div>
        
        <button className='w-[90%] bg-blue-500 text-white font-bold py-4 my-2 rounded-full text-md'>Tweet</button>
        </div>
        </div>
    )
}
